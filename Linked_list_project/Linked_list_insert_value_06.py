...
linked_list.insert_at(0, 000)
linked_list.insert_at(1, 000)
linked_list.insert_at(2, 000)
linked_list.insert_at(3, 000)
linked_list.insert_at(4, 000)
linked_list.insert_at(5, 000)
linked_list.insert_at(6, 000)
linked_list.print_linked_list()
print("After Insert List Size:-", linked_list.get_length())
#
print('Data Insert At Specific Index In Linked List!')
linked_list.insert_at(1, 100+220)
linked_list.insert_at(3, 4440/32)
linked_list.insert_at(5, 1223*32/12)
linked_list.insert_at(7, 'reslt')
linked_list.insert_at(9, 'Python')
linked_list.insert_at(11, 'Python')
linked_list.print_linked_list()
print("After Insert List Size:-", linked_list.get_length())
